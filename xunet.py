...
from models.XuNet import XuNet
...
model_save_dir = os.path.join('checkpoints', 'XuNet')
results_save_dir = os.path.join('results', 'XuNet')
...
if c.mode == 'test':
    ...
    model = load_model(model, c.pre_trained_xunet_path)
